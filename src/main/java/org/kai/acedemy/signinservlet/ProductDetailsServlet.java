...
//    String productID = params[0];
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //S10_1678
        String productId = String.valueOf(request.getParameterValues("productId"));
        Root<Product> root = criteriaQuery.from(Product.class);
        criteriaQuery.where(builder.equal(root.get("productCode"), "S10_1678"));

        System.out.println(productId +"lalam");
        ...
        try {
            ...
            for (Product pro : products) {
                ...
                out.println("                            <img class=\"card-img-top\" src=\n" + pro.getProductImageLink() + " alt=\"...\" width=\"100%\" />                                                                                                                                                                      ");
                out.println("                            <!-- Product details-->                                                                                                                                                                                                                                               ");
                out.println("                                <div class=\"text-center\" name=\"productId\" style =\"display:none\">" + pro.getProductCode() + "                                                                                                                                                                ");
                out.println("                                </div>                                                                                                                                                                                                                                                            ");
                ...
                out.println("                                <div class=\"text-center\"><a class=\"btn btn-outline-dark mt-auto\" href=\"/SignInServlet/products\">View details</a></div>                                                                                                                                      ");
                out.println("                            </div>                                                                                                                                                                                                                                                                ");
                out.println("                        </div>                                                                                                                                                                                                                                                                    ");
            }
